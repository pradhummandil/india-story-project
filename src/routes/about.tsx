...
const techStack = [
  { name: "React & TanStack", icon: Code2, desc: "Type-safe client with high-performance routing and state management" },
  { name: "Prisma & PostgreSQL", icon: Cpu, desc: "Relational data modeling with migration-safe schema management" },
  { name: "Supabase", icon: Zap, desc: "Real-time auth, storage, and serverless database at the edge" },
  { name: "Gemini AI", icon: Brain, desc: "Context-aware AI chatbot trained on India's story database" },
];
      ...
      <div className="bg-background text-foreground min-h-screen">
        ...
        <section className="relative overflow-hidden pt-32 pb-24 md:pt-44 md:pb-32 border-b border-border/40 bg-black">
          ...
          <div className="container mx-auto px-6 relative max-w-5xl text-center">
            ...
            >
              In a world dominated by outrage cycles and fleeting headlines, the quiet stories of positive change — local craftsmanship, community innovations, and grassroots heroes — are constantly being drowned out. We exist to change that.
            </motion.p>
          ...
          <div className="container mx-auto px-6 max-w-6xl">
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                ...
                <span className="text-[11px] uppercase tracking-[0.2em] font-sans font-bold text-gold">Mission</span>
                ...
                <p className="text-muted-foreground leading-relaxed text-sm font-sans">
                  ...
                  No SEO sensationalism. No hot-takes. Just real, transformative India.
                </p>
              </motion.div>
              ...
              >
                ...
                <span className="text-[11px] uppercase tracking-[0.2em] font-sans font-bold text-gold">Vision</span>
                <h2 className="font-display text-2xl md:text-3xl font-bold mt-2 mb-4 leading-snug">
                  The Living Archive of Bharat
                </h2>
                <p className="text-muted-foreground leading-relaxed text-sm font-sans">
                  A public treasury where readers around the globe discover who India is becoming — told directly through the lens of local builders, artisans, solar pioneers, and grassroots change agents. A living, evolving record of modern Bharat.
                </p>
              </motion.div>
            </div>
          </div>
        ...
        <section className="py-24 bg-card/10 border-b border-border/40">
          <div className="container mx-auto px-6 max-w-4xl text-center">
            ...
            >
              <span className="text-[11px] uppercase tracking-[0.2em] font-sans font-bold text-gold">Context</span>
              ...
              <p className="text-base md:text-lg text-muted-foreground leading-relaxed font-sans max-w-3xl mx-auto">
                Traditional mass media reduces the narrative of developmental India to administrative metrics and transient noise.
                The human factor — the village schoolteacher who built a digital library, the farmer restoring heirloom seeds,
                the weaver preserving lost indigo patterns — is lost. We tell these stories because they represent
                the true, resilient foundation of Bharat.
              </p>
            </motion.div>

            <div className="mt-16 grid sm:grid-cols-2 gap-5 text-left">
              {[
                { icon: BookOpen, text: "Over 500+ long-form stories published with full editorial oversight" },
                { icon: MapPin, text: "All 36 States and Union Territories represented in our archive" },
                { icon: Users, text: "A growing community of verified contributors from across India" },
                { icon: Award, text: "Recognized by readers as India's most credible human-interest platform" },
              ].map((item, i) => (
                <motion.div
                  key={i}
                ...
                >
                  ...
                  <p className="text-sm font-sans text-foreground/80 leading-relaxed">{item.text}</p>
                </motion.div>
              ))}
            </div>
          </div>
        ...
        <section className="py-24 border-b border-border/40">
          <div className="container mx-auto px-6 max-w-6xl">
            <div className="text-center mb-16">
              <span className="text-[11px] uppercase tracking-[0.2em] font-sans font-bold text-gold">Our Principles</span>
        ...
        <section className="py-24 bg-card/10 border-b border-border/40">
          <div className="container mx-auto px-6 max-w-5xl">
            <div className="text-center mb-16">
              <span className="text-[11px] uppercase tracking-[0.2em] font-sans font-bold text-gold">Our Process</span>
              <h2 className="font-display text-3xl md:text-5xl font-bold mt-3 leading-tight">
                Story Selection Process
              </h2>
        ...
        <section className="py-24 border-b border-border/40">
          <div className="container mx-auto px-6 max-w-5xl">
            <div className="text-center mb-16">
              <span className="text-[11px] uppercase tracking-[0.2em] font-sans font-bold text-gold">The Architect</span>
              <h2 className="font-display text-3xl md:text-5xl font-bold mt-3 leading-tight">
                Meet the Builder
              </h2>
              <p className="mt-4 text-muted-foreground font-sans max-w-xl mx-auto text-sm">
                  ...
                  <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center md:items-start">
                    ...
                    <div className="flex-1 text-center md:text-left space-y-5">
                      <div>
                        ...
                        <div className="flex flex-wrap justify-center md:justify-start gap-2 mt-3">
                          {[
                            ...
                            <span key={i} className="inline-flex items-center gap-1.5 text-[10px] uppercase font-bold tracking-wider text-gold/80 bg-gold/8 border border-gold/15 px-2.5 py-1 rounded-full font-sans">
                      ...
                      <p className="text-sm text-muted-foreground leading-relaxed font-sans">
                        Pradhum Mandil is the principal architect of the India Story Project. He designed the entire platform from first principles — engineering the high-performance TanStack routing engine, building the real-time Supabase Auth and database layer, developing the hybrid Cloudinary/Supabase media storage pipeline, and integrating the context-aware Gemini AI chatbot that surfaces local hero stories across Bharat.
                      </p>

                      <div className="flex justify-center md:justify-start items-center gap-3 pt-1">
                        {[
                          { icon: Github, href: "https://github.com", label: "GitHub", hint: "github.com/pradhummandil" },
                          { icon: Linkedin, href: "https://linkedin.com", label: "LinkedIn", hint: "linkedin.com/in/pradhum" },
                          { icon: Twitter, href: "https://twitter.com", label: "Twitter / X", hint: "@pradhummandil" },
                        ].map((soc, i) => (
                          <a
                            key={i}
                            href={soc.href}
        ...
        <section className="py-20 border-b border-border/40 bg-card/5">
          <div className="container mx-auto px-6 max-w-5xl">
            <div className="text-center mb-12">
              <span className="text-[11px] uppercase tracking-[0.2em] font-sans font-bold text-gold">Architecture</span>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {techStack.map((tech, i) => (
                ...
                >
                  ...
                  <h4 className="font-sans font-bold text-sm text-foreground mb-1.5">{tech.name}</h4>
                  <p className="text-[11px] text-muted-foreground font-sans leading-relaxed">{tech.desc}</p>
                </motion.div>
              ))}
            </div>
          </div>
