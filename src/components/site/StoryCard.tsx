...
export const StoryCard = React.memo(function StoryCard({
  ...
  return (
    ...
    >
      {/* TiltCard wrapper — 6° intensity, disabled on touch */}
          ...
          <article className="border border-border/60 bg-card hover:bg-card/85 hover:border-gold/50 hover:shadow-elegant transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] flex flex-col h-full justify-between overflow-hidden p-3.5 sm:p-4 rounded-xl relative group/card flex-1">
            ...
            <div className="aspect-[16/10] relative overflow-hidden bg-muted mb-2.5 border border-border/40 group-hover/card:border-gold/30 transition-colors duration-300 rounded-lg shrink-0">
              <UniversalImage
                ...
                className="filter saturate-[0.9] group-hover/card:scale-[1.05] group-hover/card:saturate-100 transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)]"
              />
            ...
            <div className="flex flex-col gap-1.5 flex-1 justify-start">
              <h3 className="font-display text-base font-bold leading-snug text-foreground group-hover/card:text-primary transition-colors duration-200 line-clamp-2 min-h-[2.5rem]">
            ...
            {/* Footer */}
            <div className="mt-3 pt-2.5 border-t border-border/40 flex items-center justify-between text-[11px] font-bold text-primary font-sans group-hover/card:text-gold transition-colors duration-200 uppercase tracking-wider">
